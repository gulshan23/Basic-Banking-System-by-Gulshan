...
<head>
    ...
    <title>Welcome to BBM Foundation Bank</title>
...
<div id="container">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap" href="contact_me.php">Contact Me</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <img src="images/bg3.png" alt="" style="width:auto; position:absolute; z-index:-1">
    <div class="container-large"
        style="color:white; height:250px; width: 100%; padding:1% 2% 2% 2%;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:left;"><b>Welcome to BBM Foundation
                        Bank!</b></p>
            </div>
        </div>
    </div>
    ...
    <footer>
        <p style="color: white; text-align:center; ">Copyright © 2022 <br> Made By Gulshan Kumar</p>
    </footer>
</div>
</body>
