...
<body style="background-image:url('statics/5570834-min.jpg'); padding-top:8%;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="images/bbm-logo.png" alt=""
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap active" href="contact_me.php">Contact Me</a>
                    </li>
                </ul>
            </b>
        </div>
...
?>
    <style>
        ...
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            ...
            <div class="container"
                style=" float:right; backdrop-filter: blur(5px);  border-radius:5px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%;">
            ...
            <div style="float:unset; padding: 20px 20px 20px 20px; margin-top:50px; ">
            <img src="images/gulshan1.jpg" alt="Gulshan Kumar BIT Sindri Dhanbad" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Gulshan Kumar</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> BIT Sindri, Dhanbad</b></p>
            </div>
